<script lang="ts">
  ...
  function setupComment() {
    ...
    elem.getElementsByClassName("replies")[0].parentElement.style.display =
      comment.replies > 0 ? "inline" : "none";
...
<div
  class="comment"
  bind:this={elem}
  style={`display: ${$options.showComments ? "block" : "none"}`}
>
  ...
  <div class="comment-body">Text here</div>
...
<style>
  .comment {
    ...
    animation: commentAnimation 5s cubic-bezier(0.2, 0.6, 0.8, 0.9) infinite;
  }
