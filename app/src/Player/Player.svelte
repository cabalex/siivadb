...
<div class="player" transition:slide={{duration: 200, easing: cubicOut}}>
    ...
    <a href={`https://www.youtube.com/watch?v=${$currentRip.ytid}`} rel="noopener noreferrer" target="_blank">
        <h2>
            {$currentRip.rawname}
        </h2>
    </a>
    <div class="player-actions">
        ...
        <a class="btn" rel="noopener noreferrer" target="_blank" href={`https://siivagunner.fandom.com/wiki/${encodeURIComponent($currentRip.rawname.replace("#", ""))}`}>
            Visit wikia page
            <OpenInNew />
        </a>
    </div>
    ...
    <div class="video">
        ...
        <YouTube
            options={{
                ...
                playerVars: {autoplay: 1, modestbranding: 1, rel: 0, showinfo: 0, playsinline: 1}
            }}
